...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.axios.post('/api/register', _this.dataUser).then(function (Response) {
    ...
    clearDataUser: function clearDataUser() {
      this.dataUser = {
        name: '',
        email: '',
        password: ''
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "col-8 mx-auto p-3 bg-light border rounded" }, [
      _c(
        ...
        [
          _c("legend", [_vm._v("Create Usuario")]),
          _vm._v(" "),
          _c("div", [
            _c(
              "label",
            ...
            _c("input", {
              ...
              domProps: { value: _vm.dataUser.name },
              on: {
                input: function ($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.dataUser, "name", $event.target.value)
                },
              },
            }),
          ]),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.dataUser.role,
                  expression: "dataUser.role",
                },
              ],
              staticClass: "form-control",
              attrs: { type: "text", readonly: "", id: "lastname" },
              domProps: { value: _vm.dataUser.role },
              on: {
                input: function ($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.dataUser, "role", $event.target.value)
                },
              },
            }),
          ]),
          ...
          _c("div", [
            ...
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "password", id: "code", autocomplete: "off" },
