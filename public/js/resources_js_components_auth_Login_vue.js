...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loginAcces: function loginAcces() {
      var _this = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.axios.post('/api/login', _this.dataLogin).then(function (Response) {
                alert('Logged in user');
                _this.clearDataLogin();
                _this.$router.push({
                  name: "dashboard"
                });
    ...
    clearDataLogin: function clearDataLogin() {
      this.dataLogin = {
        email: '',
        password: ''
      };
                ...
                "form",
                {
                  on: {
                    submit: function ($event) {
                      ...
                      return _vm.loginAcces.apply(null, arguments)
                    },
                  },
                },
                [
